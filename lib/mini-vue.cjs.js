...
function intiProps(instance, rawProps) {
...
function createCompenentInstance(vnode, parent) {
...
function propcessFragment(vnode, container, parentComponent) {
    mountChildren(vnode, container, parentComponent);
}
function propcessText(vnode, container) {
